...
var shoppingCart = (function () {
  ...
  // }
      output += '<div class="row">' +
        ...
        '   <button class="delete-item btn btn-danger" data-name=' + cartArray[i].name + '>Remove from Cart </button> ' +
        '   <div class="hr_line"></div> '+
        // '<a href="" data-name=' + cartArray[i].name + ' data-price=' + cartArray[i].total*60/100 + ' class="add-to-cart"><button class="plus-item btn btn-primary input-group-addon" data-name=' + cartArray[i].name + '>Add To Wishlist</button></a> ' +
  '  </div>' +
        '   </div>'
